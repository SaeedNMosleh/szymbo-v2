...
export function ConjugationTableQuestion({ 
  ...
  const conjugationForms: ConjugationForm[] = [
    ...
    { person: "3rd", number: "singular", form: "on/ona/ono", placeholder: "on/ona/ono..." },
    { person: "1st", number: "plural", form: "my", placeholder: "my..." },
    { person: "2nd", number: "plural", form: "wy", placeholder: "wy..." },
    { person: "3rd", number: "plural", form: "oni/one", placeholder: "oni/one..." },
  ];
  ...
  const handleConjugationChange = (form: string, value: string) => {
    ...
    const answersArray = conjugationForms.map(cf => newConjugations[cf.form] || '');
      ...
      <CardContent className="pt-6">
        <div className="space-y-4">
            ...
            {conjugationForms.map((form, index) => (
              <div key={form.form} className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleConjugationChange(form.form, e.target.value)}
          ...
          <div className="text-sm text-gray-600">
            ...
            <p className="mt-1">Pay attention to the proper verb endings for each person and number.</p>
          </div>
        </div>
      </CardContent>
    </Card>
