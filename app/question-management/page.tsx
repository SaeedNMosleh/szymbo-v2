        ...
        <TabsContent value="planner" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Plan and generate batches of questions for selected concepts and
                types
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="drafts" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Review all draft questions (generated and manual) before saving to question bank
              </CardDescription>
            </CardHeader>
            <CardContent>
              <QuestionDraftReview
        ...
        <TabsContent value="editor" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Create questions manually and add them to the draft review queue
              </CardDescription>
            </CardHeader>
            <CardContent>
